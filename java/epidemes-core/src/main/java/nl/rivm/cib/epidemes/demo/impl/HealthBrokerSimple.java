...
import nl.rivm.cib.epidemes.model.VaxDose;
import nl.rivm.cib.epidemes.model.VaxOccasion;
import nl.rivm.cib.epidemes.model.VaxRegimen;
...
//		double overallVaccinationDegree();
		...
		@DefaultValue( "nl.rivm.cib.epidemes.demo.impl.VaxRegimenSimpleMeaslesRVP" )
		Class<? extends VaxRegimen> regimenType();

		@Key( VACCINATION_PREFIX + "acceptance-evaluator" )
		@DefaultValue( "nl.rivm.cib.epidemes.demo.impl.VaxAcceptance4CSimple" )
