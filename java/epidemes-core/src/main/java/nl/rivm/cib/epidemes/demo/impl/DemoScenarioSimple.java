...
import nl.rivm.cib.epidemes.demo.entity.Regions.RegionTuple;
...
import nl.rivm.cib.epidemes.demo.entity.Societies.SocietyTuple;
import nl.rivm.cib.epidemes.model.MSEIRS.Compartment;

/**
 * {@link DemoScenarioSimple}
 * 
 * @version $Id$
 * @author Rick van Krevelen
 */
public class DemoScenarioSimple implements DemoScenario
{

	/** */
	private static final Logger LOG = LogUtil
			.getLogger( DemoScenarioSimple.class );
