...
/**
 * {@link TravelFact} generated by some {@link Individual} tracks the
 ...
 */
@Deprecated
public class TravelFact // TODO extends Fact
{
	...
	/**
	 * {@link TravelFact} constructor
	 * 
	 * @param traveler the {@link Individual}
	 * @param origin the {@link Place} of origin
	 * @param transport the transport {@link Transporter}
	 * @param destination the {@link Place} of destination
	 * @param arrivalDelay the {@link Duration} of travel
	 */
	public TravelFact( final Individual traveler, final Place origin,
		final Transporter transport, final Place destination,
