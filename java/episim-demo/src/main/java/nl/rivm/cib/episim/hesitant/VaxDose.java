...
public class VaxDose implements Identified.Ordinal<VaxDose.ID>
{
	static class ID extends Id.OrdinalChild<Integer, String>
	{
		public static VaxDose.ID of( final Integer value, final String series )
		{
