...
public abstract class Condition
{
	 ...
	 *            {@link Condition}
	 */
	public static void on( ContactEvent event )
	{
	}

	public static void on( TransitionEvent event )
	{
	}

	/**
	 * @param stage to test
	 * @return the current {@link Stage} of this {@link Condition}
	 */
	public abstract Stage getStage();

	/**
	 * @return an {@link Observable} stream of {@link TransitionEvent}s
	 *         generated by changes in {@link Condition} of {@link Infection}s
	 *         of this {@link Carrier}
	 */
	public abstract Observable<TransitionEvent> emitStages();

	/**
	 * @return {@code true} iff this {@link Condition} is during prophylactic
	 *         treatment (e.g. PrEP or PEP), {@code false} otherwise
	 */
	public abstract boolean isProphylactic();
