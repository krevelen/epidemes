...
public interface EpiTrajectory extends IllnessTrajectory
{
	...
	interface EpiCondition extends IllnessTrajectory.Condition
	{
		...
		class SimpleEpiClinical extends
			Attributed.Publisher.SimpleOrdinal<SimpleEpiClinical> implements
		...
		implements EpiTrajectory, JsonConfigurable<SimpleClinical>
	{
		...
		protected Quantity<Time> dtMapper( final EpiTransition configKey )
		{
		...
		protected void wane()
		{
			...
			after( dtMapper( EpiTransition.SUSCEPTIBILITY ) )
					.call( this::expose );
		}

		/**
		 * sets condition {@link #EXPOSED} and schedules both {@link #shed}
		 * after {@link EpiTransition#LATENCY} and {@link #clinical} after
		 * {@link EpiTransition#APPEARANCE} is 'consumed'
		 */
		protected void expose()
		{
			this.emitter.onNext( this.condition
					.updateAndGet( c -> SimpleEpiClinical.EXPOSED ) );
			after( dtMapper( EpiTransition.LATENCY ) ).call( this::shed );
			after( dtMapper( EpiTransition.APPEARANCE ) )
					.call( this::clinical );
		}

		/**
		 * sets condition {@link #INFECTIVE} or {@link #APPARENT_INFECTIVE} and
		 * schedules {@link #recover} after {@link EpiTransition#INFECTIOUS} is
		 * 'consumed'
		 */
		protected void shed()
		{
		...
		protected void clinical()
		{
			...
			after( dtMapper( EpiTransition.DISAPPEARANCE ) )
		 ...
		 * {@link EpiTransition#WANING} is 'consumed'
		 */
		protected void recover()
		{
			this.emitter.onNext( this.condition
					.updateAndGet( c -> SimpleEpiClinical.RECOVERED ) );
			after( dtMapper( EpiTransition.WANING ) ).call( this::wane );
		}
	 ...
	 */
	interface Factory extends IllnessTrajectory.Factory
	{
		@Override
