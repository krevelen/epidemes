 ...
 * {@link Route} at some {@link Location} with secondary susceptible
 * {@link Individual}s
 * 
 * @version $Id$
...
{
	/**
	 * @return the {@link Route} determines the type of contact
	 */
	Route getMedium();

	/**
	 * @return the contact {@link Location} (if applicable)
	 */
	...
	/**
	 * @return the contact {@link Duration} (if applicable)
	 */
	Duration getDuration();

	/**
	 * @return a {@link Map mapping} of {@link Infection} to (infective)
	 *         {@link Condition}
	 */
	Map<Infection, Condition> getPrimaryInfectiveDiseases();
