...
public interface TransmissionSpace
	extends Actor<TransmissionSpace.Transmission>
{
	interface Transmission extends Fact
	{
	...
	/**
	 * @return an {@link Observable} stream of {@link Visit}s generated
	 *         by {@link Afflicted} occupants of this {@link TransmissionSpace}
	 */
	Observable<Visit> emitContacts();

	/**
	 * @return an {@link Observable} stream of {@link Exposure}s
	 *         generated by {@link Afflicted} occupants of this
	 *         {@link TransmissionSpace}
	 */
	Observable<Exposure> emitTransmissions();
...
//	}
	 ...
	 * to generate {@link Visit}s and {@link Exposure}s based on
...
//	}
	 ...
	 * {@link Visit}s which in turn may trigger its transmission by
	 * generating {@link Exposure}s.
	 */
