 ...
 */
public interface TransmissionSpace
	extends Proactive, Identified<TransmissionSpace.ID>
{
	...
	/**
	 * @return an {@link Observable} stream of {@link TransmissionFact}s
	 *         generated by {@link Afflicted} occupants of this
	 *         {@link TransmissionSpace}
	 */
	Observable<TransmissionFact> emitTransmissions();
	 ...
	 * to generate {@link ContactEvent}s and {@link TransmissionFact}s based on
	 ...
	 * generating {@link TransmissionFact}s.
	 * 
	 * @version $Id: 7fdd24bb4c0e75e36d0a85c343e8ff6fa341cad4 $
	 * @author Rick van Krevelen
	 */
		...
		implements TransmissionSpace
	{
		...
		private final transient Subject<TransmissionFact, TransmissionFact> transmissions = PublishSubject
				.create();
		...
		@Override
		public Observable<TransmissionFact> emitTransmissions()
		{
