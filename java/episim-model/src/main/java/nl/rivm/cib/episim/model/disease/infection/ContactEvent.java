...
/**
 * {@link ContactEvent} generated by some {@link TransmissionSpace} represents
 * the interval ({@link #getStart()} and {@link #getDuration()}) when a primary
 * {@link Afflicted} (e.g. carrying some {@link Infection} at infective
 * {@link EpidemicCompartment}) shared some transmission
...
public class ContactEvent
{
	...
	private TransmissionRoute route;

	private Condition primary;

	private Condition secondary;

	public ContactEvent( final Instant start, final Duration duration,
	...
	/** @return the contact {@link TransmissionSpace} */
	...
	/**
	 * @return the {@link Condition} of the primary (infective)
	 *         {@link Afflicted}
	 */
