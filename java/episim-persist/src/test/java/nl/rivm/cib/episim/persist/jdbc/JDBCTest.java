...
{
	/** */
	private static final Logger LOG = LogUtil.getLogger( JDBCTest.class );
	...
	public void testJDBC() throws SQLException
	{
		...
		jdbc.execute( "INSERT INTO REGISTRATION (id, first, last) VALUES "
				+ "(0,'Rick','van Krevelen')" + ", (1,'Joram','Hoogink')", rs ->
				{
